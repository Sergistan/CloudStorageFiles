...
public class AuthServiceTest {
    ...
    void login() {
        ...
        assertEquals(RESPONSE_JWT, authService.login(REQUEST_AUTH));
    ...
    void logout() {
        ...
        Mockito.verify(authRepository, Mockito.times(1)).getAuthenticationUserByToken(BEARER_TOKEN_SUBSTRING_7);
